...
class Prompt:
        ...
        while True:
            match self.main_input:
                ...
                case 2:
                    ...
                    todo.get_num_of_lists()
                    print("")
                    while True:
                        sub_input = int(input("Which file do you wish to read?:\n"))
                        if sub_input in range(1, todo.num_of_lists + 1):
                            break
                        else:
                            print("\nInput is invalid, must match one of the files!\n")
                            todo.recursively_print_lists()
                            print("")
                    print("")
                ...
                case 3:
                    ...
                    while True:
                        sub_input = int(
                            input("Which file do you wish to append to?:\n")
                        )
                        if sub_input in range(1, todo.num_of_lists + 1):
                            break
                        else:
                ...
                case 5:
                    ...
                    while True:
                        sub_input = int(
                            input("Which todo list do you wish to delete?:\n")
                        )
                        if sub_input in range(1, todo.num_of_lists + 1):
                            break
                        else:
    ...
    def initial_check(self):
        ...
        if os.path.exists(todo.rootdirname):
            pass
        else:
            os.mkdir(todo.rootdirname)
...
class Todo:
    def __init__(self):
        self.rootdirname = f"{Path.home()}/.config"
    ...
    def append_file(self, todo_file: str):
        ...
        with open(todo_file, "a") as f:
            f.write(
                f"- "
                + input(f"\nWhat do you wish to append to your TO-DO entry?:\n")
                + "\n"
            )
        print("")
